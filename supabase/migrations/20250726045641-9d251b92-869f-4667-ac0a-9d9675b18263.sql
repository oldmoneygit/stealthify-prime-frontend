...
DROP POLICY IF EXISTS "Users can view their own logs" ON public.integration_logs;
DROP POLICY IF EXISTS "Users can create their own logs" ON public.integration_logs;
